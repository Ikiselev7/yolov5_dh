...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        with dt[1]:
            ...
            pred = model(im, augment=augment, visualize=visualize, head=head)
...
def parse_opt():
    ...
    parser.add_argument('--head', type=int, default=0, help='inference head (0, 1)')
